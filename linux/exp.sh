...
./line -train ../data/"${exp}"_adj_dense.txt -output "$foldername"/vec_1st_wo_norm.txt -binary 0 -size ${size} -order 1 -negative 5 -samples 1000 -threads 40
./line -train ../data/"${exp}"_adj_dense.txt -output "$foldername"/vec_2nd_wo_norm.txt -binary 0 -size ${size} -order 2 -negative 5 -samples 1000 -threads 40
...
python concate.py "$foldername"/vec_1st_wo_norm.txt "$foldername"/flickr_1st_100.npy "$foldername"/flickr_1st_100.txt
python concate.py "$foldername"/vec_2nd_wo_norm.txt "$foldername"/flickr_2nd_100.npy "$foldername"/flickr_2nd_100.txt
