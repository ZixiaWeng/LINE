...
./line -train "$foldername"/net_"${exp}"_adj_directed_dense.txt -output "$foldername"/vec_1st_wo_norm.txt -binary 0 -size 128 -order 1 -negative 5 -samples 10000 -threads 40
./line -train "$foldername"/net_"${exp}"_adj_directed_dense.txt -output "$foldername"/vec_2nd_wo_norm.txt -binary 0 -size 128 -order 2 -negative 5 -samples 10000 -threads 40
