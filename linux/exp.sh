...
./line -train ../data/"${exp}"_adj_undirected.txt -output "$foldername"/vec_1st_wo_norm.txt -binary 0 -size ${size} -order 1 -negative 5 -samples 1000 -threads 40
./line -train ../data/"${exp}"_adj_undirected.txt -output "$foldername"/vec_2nd_wo_norm.txt -binary 0 -size ${size} -order 2 -negative 5 -samples 1000 -threads 40
